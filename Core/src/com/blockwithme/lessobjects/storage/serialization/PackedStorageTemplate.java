...
public class PackedStorageTemplate extends BaseStorageTemplate<PackedStorage> {

    /** Instantiates a new packed storage template. */
    protected PackedStorageTemplate() {
        super(PackedStorage.class);
    }
    ...
    public final int getSpaceRequired(final PackerContext theContext,
            final PackedStorage theStorage) {
    ...
    @SuppressWarnings("null")
    @Override
    public PackedStorage readData(final UnpackerContext theContext,
            final PackedStorage thePreCreated, final int theSize)
            throws IOException {
        ...
        return new PackedStorage(builder);
    }
    ...
    public void writeData(final PackerContext theContext, final int theSize,
            final PackedStorage theValue) throws IOException {
