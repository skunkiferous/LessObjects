...
public class TestListInsideOptionalChild extends TestData {
    ...
    private void compareResults(final String message, final Struct struct1,
        ...
        final IntField intField1 = struct1.field("OptionalChild.intField");
        final LongField longField1 = struct1.field("OptionalChild.longField");
        final ObjectField<String, ?> str1 = struct1
                .field("OptionalChild.stringField1");

        final IntField intField2 = struct1
                .field("OptionalChild.ListChild.intField");
        final LongField longField2 = struct1
                .field("OptionalChild.ListChild.longField");
        final ObjectField<String, ?> str2 = struct1
                .field("OptionalChild.ListChild.stringField1");

        final Struct listChild = struct1.child("OptionalChild.ListChild");
    ...
    private Struct struct() {
        ...
        Struct optionalChild = new Struct("OptionalChild",
        ...
        final Struct bs = new Struct("Struct", new Struct[] { optionalChild },
                new Field<?, ?>[] { FACTORY.newIntField("intField") });
        return bs;
    }
