...
@BenchmarkMethodChart(filePrefix = "ReadTest")
public class ReadTest extends AbstractBenchmark {

    protected boolean optionalFields = false;
    ...
    public void _64K_Aligned64_Random_Proxy() {
        util.randomReadsProxy(ELEMENTS_READ, READ_ITERATIONS);
    }

    @Test
    @BenchmarkOptions(benchmarkRounds = 5, warmupRounds = 2)
    public void _64K_Aligned64_Random_Wrapper() {
        util.randomReadsWrapper(ELEMENTS_READ, READ_ITERATIONS);
    }
    ...
    public void _64K_Aligned64_Sequential_Proxy() {
        util.sequentialReadsProxy(ELEMENTS_READ, READ_ITERATIONS);
    }

    @Test
    @BenchmarkOptions(benchmarkRounds = 5, warmupRounds = 2)
    public void _64K_Aligned64_Sequential_Wrapper() {
        util.sequentialReadsWrapper(ELEMENTS_READ, READ_ITERATIONS);
    }
    ...
    public void _64K_Bean() {
        util.readBean(ELEMENTS_READ, READ_ITERATIONS);
    }
    ...
    public void _setUp() {
        ...
        util = new StorageUtil(compiler, _64K, false, true, createStorage,
                createProxy, createBean, createWrapper, createWrapper2L,
                optionalFields);
    }
}
