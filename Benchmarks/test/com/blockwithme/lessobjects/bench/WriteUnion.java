...
public abstract class WriteUnion extends AbstractBenchmark {
    ...
    protected void init(final boolean recordChanges,
        ...
        util = new StorageUtilUnion(ALIGNED64, _64K, recordChanges,
                false);
    ...
    public void _64K_Random() {
        util.randomWrites(ELEMENTS_READ, numberOfIterations);
    }

    @Test
    @BenchmarkOptions(benchmarkRounds = 5, warmupRounds = 2)
    public void _64K_Sequential() {
        util.sequentialWrites(ELEMENTS_READ, numberOfIterations);
    }
}
