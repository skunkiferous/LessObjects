...
public interface ProxyTransactionListener {

    /**
     * This method is invoked after the commit/rollback is performed.

     * @param theSource the source ProxyCursor object
     ...
     */
    void postCommit(ActionSet theActions, final ProxyCursor theSource,
            boolean isCommit);
     ...
     * @param isCommit true is passed if the transaction is being committed, false in case its being rolled back
     */
    void preCommit(ActionSet theActions, final ProxyCursor theSource,
            boolean isCommit);
